...
NAVIGATION_LINKS = {
    ...
    "es": (
        ...
        ("/es/disclosed-vulnerabilities/", "Disclosed vulnerabilities"),
        ("/es/about/", "Acerca de"),
    ),
}
...
POSTS = (
    ("posts/*.rst", "posts", "post-custom.tmpl"),
    ("posts/*.md", "posts", "post-custom.tmpl"),
    ("posts/*.txt", "posts", "post-custom.tmpl"),
...
<script defer src='https://static.cloudflareinsights.com/beacon.min.js' data-cf-beacon='{"token": "f0bcc690290a454ab2e555da28759807"}'></script>
